...
if __name__ == "__main__":
    ...
    if 2 != len(sys.argv):
        print('Usage:\n\t' + sys.argv[0] + ' onnx_model_path')
        sys.exit(0)

    onnx_path = sys.argv[1]
    prototxt_path = onnx_path.replace('onnx', 'prototxt') # "./face_not_focus.prototxt"
    caffemodel_path = onnx_path.replace('onnx', 'caffemodel') # "./face_not_focus.caffemodel"
